...
names=["Jhon", "Harry", "Khushi", "Riya"]
cities=["Delhi", "Mumbai", "Bangalore", "Chennai","Kolkata"]
def print_len(names):
    return len(names)
print(print_len(names))

def print_len(message,list):
    print(message,len(list))
print_len("no of names are:",names)
print_len("no of cities are:",cities) 
